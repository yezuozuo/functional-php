...
class __ {
     ...
     * include alias: contains
     *
     * @param null $collection
     * @param null $val
     * @return __
     */
    public function contains($collection = null, $val = null) {
        return self::includ($collection, $val);
    }
     ...
     * @return __
     */
    public function some($collection = null, $iterator = null) {
        return self::any($collection, $iterator);
    }
    ...
    public function first($collection = null, $n = null) {
        ...
        if (is_null($n)) {
            return self::_wrap(current(array_splice($collection, 0, 1, true)));
        }
    ...
    public function tail($collection = null, $index = null) {
        return self::rest($collection, $index);
    }
    ...
    /**
     * Return a copy of the array with false values removed
     *
     * @param null $collection
     * @return __
     */
    ...
    public function union($array = null) {
        ...
        return self::_wrap($__->flatten(array_values(array_unique($__->flatten($arrays)))));
    }
     ...
     *
     * @param null $array_one
     * @param null $array_two
     * @return __
     */
    ...
    public function max($collection = null, $iterator = null) {
        ...
        if (is_null($iterator)) {
            return self::_wrap(max($collection));
        }
    ...
    public function templateSettings($settings = null) {
        ...
        foreach ($settings as $k => $v) {
            if (!array_key_exists($k, $_template_settings)) {
                continue;
            }
    ...
    public function memoize($function = null, $hashFunction = null) {
        ...
        return self::_wrap(function () use ($function, &$_instance, $hashFunction) {
            ...
            if (is_null($hashFunction)) {
                $hashFunction = function ($function, $args) {
    ...
    public function after($count = null, $function = null) {
        ...
        $func = function () use ($function, &$_instance, $count, $key) {
            if (!array_key_exists($key, $_instance->_aftered)) {
                $_instance->_aftered[$key] = 0;
            }
            $_instance->_aftered[$key] += 1;

            if ($_instance->_aftered[$key] >= $count) {
                return call_user_func_array($function, func_get_args());
            }
        };
